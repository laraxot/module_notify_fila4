...
`ContactTypeEnum` è il componente centrale per la gestione dei contatti nel sistema Meetup. Fornisce una struttura unificata per tutti i tipi di contatto (telefono, email, PEC, WhatsApp, ecc.) seguendo i principi dell'architettura Laraxot.
