...
Questo indice raccoglie tutti i riferimenti utili per il modulo **Notify**.

## 📘 Documentazione Principale
- [README](./README.md) – panoramica, quick start, architettura
- [CHANGELOG](./CHANGELOG.md) – cronologia modifiche
- [PSR-4 Namespace Fix](./psr4-namespace-fix.md) – dettagli correzioni Novembre 2025

## 🔌 Canali e Template
- [Email](./email-sending/README.md)
